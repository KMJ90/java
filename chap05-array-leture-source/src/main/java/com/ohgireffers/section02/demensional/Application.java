package com.ohgireffers.section02.demensional;
...
public class Application {
    public static void main(String[] args) {
        ...
        // 일반적으로 2차원 배열 이상의 배열은 사용 빈도가 적다
...
//        iarr1 = new int[][];  // 크기를 지정하지 않아 에러 발생
        iarr2 = new int[3][];
//        iarr3 = new int[][3];  // 주소를 묶어서 관리할 배열의 크기를 지정하지 않아 에러
        iarr3 = new int[3][];
        ...
        // 가변배열 : 서로 [다른] 길이의 배열 여러 개를 하나로 묶어 관리하는 2차원 배열
        ...
        for (int i = 0; i < iarr3.length; i++) {
            System.out.println("iarr의 " + i + "번째 인덱스 : " + iarr3[i].hashCode() );
        ...
        int[][] iarr7 = {arr1, arr2,arr3};  // 1차원 배열을 2차원 배열로 만듬
