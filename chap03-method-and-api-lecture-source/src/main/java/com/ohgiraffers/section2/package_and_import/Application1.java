...
public class Application1 {
    public static void main(String[] args) {
        ...
        //non-static 메소드의 경우//
        com.ohgiraffers.section1.method.Calculator calc = new com.ohgiraffers.section1.method.Calculator();
        int min = calc.minNumberOf(30, 20);
        System.out.println("30과 20중 작은수?? : " + min);

        //static 메소드의 경우//
        int max = com.ohgiraffers.section1.method.Calculator.maxNumberOf(30, 20);
