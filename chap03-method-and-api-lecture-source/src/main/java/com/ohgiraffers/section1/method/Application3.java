package com.ohgiraffers.section1.method;
    ...
    public class Application3 {
        public static void main(String[] args) {
            ...
            // 전달인자(arguments)와 매개변수(paramter)를 이용한 메소드 호출 //
            ...
            Application3 app3 = new Application3();  // 객체생성
            //전달인자와 매개변수를 이용한 메소드 호출 테스트//
            app3.testMethod(40);  // int age 에 올바른 사용
//            app3.testMethod("40");  //매개변수는 int형 이지만 인자가 String형이기 때문에 에러
...
//            app3.testMethod();  //매개변수는 선언되어 있지만 인자로 값을 전달하지 않으면 에러
            ...
            byte byteAge = 10;  //작은값을 큰 값에 담을때 자동 형변환
