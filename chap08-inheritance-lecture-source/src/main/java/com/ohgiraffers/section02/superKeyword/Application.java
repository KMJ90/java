...
public class Application {
    public static void main(String[] args) {
        ...
        Computer computer2 = new Computer("퀄컴 스냅드레곤",512,12,"안드로이드");
        System.out.println(computer2.getInformation());

        Computer computer3 = new Computer("S-01234","삼성","갤럭시Z폴드",2398000,
                new java.util.Date(), "퀄컴 스냅드레곤", 512,12,"안드로이드");
