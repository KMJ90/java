...
public class Application {
    public static void main(String[] args) {
        ...
        // 자식클래스가 정의한 메소드를 동작하도록 구현부(메소드 몸체부분) 부분을 새롭게 다시 작성하는 기술이다
        // 메소드 재정의를 하면 메소드 호출 시 재정의한 메소드가 우선적으로 동작한다

        // [상속의 장점]
        // 1. 새로운 클래스 작성 시 기존에 작성한 클래스를 재상용 할 수 있다
        ...
        // [상속의 단점]
        // 1. 부모클래스의 기능을 쿠가/변경할 경우 자식클래스가 정상 동작하는지 예측이 힘들다
        //    상속 구조가 복잡해질수록 그 영향에 대한 예측이 힘들며 이런 단점이 유지보수성이 증가한다는 장점과
        //    반대로 유지보수에 악영향을 준다
