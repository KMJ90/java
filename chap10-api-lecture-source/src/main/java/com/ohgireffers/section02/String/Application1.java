package com.ohgireffers.section02.String;
...
public class Application1 {
    public static void main(String[] args) {
        ...
        // 인덱스를 벗어난 정수를 인자로 전달하는 경우 IndexOutOfBoundsException 이 발생한다
        ...
        System.out.println("substring(3,6) : " + javamysql.substring(3,6));  // amy 출력됨
        System.out.println("substring(3) : " + javamysql.substring(3));  // amysql //인덱스번호 3번자리부터 출력됨
        ...
        System.out.println("isEmpty() : " + "".isEmpty());  // true // 길이가 0임
        System.out.println("isEmpty() : " + "abc".isEmpty());  // false // 길이가 0이 아님
