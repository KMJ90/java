...
public class Application {
    public static void main(String[] args) {
        ...
        // 유연선 확보는 여러 곳에 적용될 수 있는 유연한 객체를 의미하며, 즉 재사용성이 높아질 수 있게 한다
        ...
        // 4. 운전자는 먼저 자동차에 시동을 건다. 이미 걸려있는 경우 다시 시동을 걸 수 있다
        ...
        //   1) carDriver 클래스
        //      - 속성 : 자동차(car 클래스)
        //      - 행위 : 시동을 걸어라, 엑셀 밟아라, 브레이크 밟아라, 시동을 꺼라
        //   2) car 클래스
        //      - 속성 : 시동 상태, 현재 시속
        //      - 행위(메소드) : 시동을 걸어라, 앞으로 가라, 멈춰라, 시동을 꺼라

        CarDriver driver = new CarDriver();  // 메소드 생성

        Scanner sc = new Scanner(System.in);  // 객체 생성

        // if문 대신에 while문 위에 label;을 작성하고, 아래 case 9번 break 옆에 label;을 작성해도 반복문을 빠져나올수 있다
        // label;
        while (true) {
            ...
            switch (no) {
                ...
                case 9 : System.out.println("프로그램을 종료합니다."); break; // label;
                default:
