...
//    private final int nonStaticNum;  // 0으로 초기화되어 이후 변경 불가능하기 떄문에 에러남

    private final int NNO_STATIC_NUM = 1;
    private final String NNO_STATIC_NAME;

    public FinalFieldTest(String nonStaticName) {
        this.NNO_STATIC_NAME = nonStaticName;
    }
...
//    private final int STATIC_NUM;  // 0으로 초기화 되어 이후 변경 불가능하기 때문에 에러남
    ...
    // 하지만 static 은 프로그램이 static 될 때 할당되기 때문에 초기화 되지 않은 상태로 선언된 것과 동일하여
