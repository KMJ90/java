...
public class Application1 {
    public static void main(String[] args) {
        ...
        // Collection Framework 는 크게 3가지 인터페이스중 한 가지를 상속받아 구현해 놓았다
        // 1. List 인터페이스
        // 2. Set 인터페이스
        // 3. Map 인터페이스

        // List 인터페이스와 Set 인터페이스의 공통 부분을 Collection 인터페이스에서 정의하고 있다
        // 하지만 Map 은 주조상의 차이로 Collection 인터페이스에서 정의하고 있지 않다
        ...
        // [ ArrayList ]
        // 배열의 단점을 보완하기 위헤 만들어졌다
        // 배열은 크기를 변경할 수 없고, 요소의 추가, 삭제, 정렬 등이 복잡하다는 단점을 가지고 있다
        // ArrayList 는 저러한 배열의 단점을 보완하고자 크기변경(새로운 더 큰 배열 만들고 옮기기),
        ...
        alist.set(1,true);  // valueOf : boolean <-> Boolean 변환 api 래퍼클래스 참고(오토박싱)
...
//        stringList.add(123);  // 에러발생
        ...
        Iterator<String> dIter = ((LinkedList<String>)stringList).descendingIterator();  // descending (역순)
